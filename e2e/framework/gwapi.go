...
const (
	...
	gatewayAPIInstallURL = "https://github.com/kgateway-dev/gateway-api/releases/download/" + gatewayAPIVersion + "/experimental-install.yaml"
)

// Creates all Gateway API resources and returns a cleanup function.
