...
type ResourcesToIRConverter interface {
	...
	// ToProviderIR converts stored API entities to ProviderIR (before EmitterIR conversion).
	// This is used by ImplementationEmitters that need access to provider-specific fields.
	ToProviderIR() (providerir.ProviderIR, field.ErrorList)
}
