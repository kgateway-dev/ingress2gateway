...
func TestAgentgatewayIngressNginxIntegration_RateLimit(t *testing.T) {
	t.Helper()
...
func TestAgentgatewayIngressNginxIntegration_Timeouts(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "timeouts",
			inputRel: filepath.Join(
				"pkg", "i2gw", "emitters", "agentgateway", "testing", "testdata", "input", "timeouts.yaml",
			),
			goldenRel: filepath.Join(
				"pkg", "i2gw", "emitters", "agentgateway", "testing", "testdata", "output", "timeouts.yaml",
			),
		},
	}
...
func TestAgentgatewayIngressNginxIntegration_CORS(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "cors",
			inputRel: filepath.Join(
				"pkg", "i2gw", "emitters", "agentgateway", "testing", "testdata", "input", "cors.yaml",
			),
			goldenRel: filepath.Join(
				"pkg", "i2gw", "emitters", "agentgateway", "testing", "testdata", "output", "cors.yaml",
			),
		},
	}
...
func TestAgentgatewayIngressNginxIntegration_RewriteTarget(t *testing.T) {
	t.Helper()
	...
	tests := []struct {
	...
	}{
		{
			name: "rewrite_target",
			inputRel: filepath.Join(
				"pkg", "i2gw", "emitters", "agentgateway", "testing", "testdata", "input", "rewrite_target.yaml",
			),
			goldenRel: filepath.Join(
				"pkg", "i2gw", "emitters", "agentgateway", "testing", "testdata", "output", "rewrite_target.yaml",
			),
		},
	}
...
func TestAgentgatewayIngressNginxIntegration_BackendProtocol(t *testing.T) {
	t.Helper()
	...
	tests := []struct {
	...
	}{
		{
			...
			inputRel: filepath.Join(
				"pkg", "i2gw", "emitters", "agentgateway", "testing", "testdata", "input", "backend_protocol.yaml",
			),
			goldenRel: filepath.Join(
				"pkg", "i2gw", "emitters", "agentgateway", "testing", "testdata", "output", "backend_protocol.yaml",
			),
		},
	}
