...
// GatewayIR is the provider-specific IR for Ingress NGINX.
type GatewayIR struct{}

// HTTPRouteIR contains Ingress NGINX-specific fields for HTTPRoute.
...
// ServiceIR contains Ingress NGINX-specific fields for Service.
